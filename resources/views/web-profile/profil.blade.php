...
<body class="bg-gray-50 text-gray-800 antialiased" x-data="{ loading: true }" x-init="setTimeout(() => loading = false, 800)">
    ...
    <div x-show="loading" class="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white">
    ...
    <div x-show="!loading" x-transition.opacity.duration.500ms>
                ...
                <div class="flex flex-col md:flex-row items-center gap-12">
                    <div class="w-full md:w-1/2">
                        <div class="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                            <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=800&auto=format&fit=crop" alt="Meeting Biro Umum" class="w-full h-auto hover:scale-105 transition duration-500">
                            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-900 to-transparent p-6">
                                <p class="text-white font-bold text-lg">Profesional & Melayani</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <h2 class="text-3xl font-bold text-gray-900 mb-6 leading-tight">Mendukung Kinerja Pimpinan Daerah dengan Pelayanan Prima</h2>
                        ...
                        <p class="text-gray-600 mb-6 leading-relaxed text-justify">
                            Kami berkomitmen untuk menyediakan fasilitas dan layanan terbaik guna memastikan kelancaran kegiatan pemerintahan di lingkungan Pemerintah Provinsi Bengkulu.
                        </p>

                        <div class="grid grid-cols-3 gap-4 border-t border-gray-100 pt-6">
                            <div>
                                <span class="block text-3xl font-bold text-blue-600">3</span>
                                <span class="text-xs text-gray-500 uppercase">Bagian Utama</span>
                            </div>
                            <div>
                                <span class="block text-3xl font-bold text-blue-600">50+</span>
                                <span class="text-xs text-gray-500 uppercase">Pegawai ASN</span>
                            </div>
                            <div>
                                <span class="block text-3xl font-bold text-blue-600">24/7</span>
                                <span class="text-xs text-gray-500 uppercase">Siap Melayani</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="py-16 bg-gray-50 relative">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                    <div class="md:col-span-4 bg-blue-900 text-white p-8 rounded-2xl shadow-xl relative overflow-hidden flex flex-col justify-center text-center">
                        <div class="absolute top-0 right-0 -mr-8 -mt-8 w-32 h-32 bg-white opacity-10 rounded-full"></div>
                        <h3 class="text-2xl font-bold mb-6 relative z-10">VISI</h3>
                        <p class="text-lg italic font-light relative z-10 leading-relaxed">
                            "Terwujudnya Pelayanan Administrasi Umum dan Rumah Tangga Pimpinan yang Cepat, Tepat, dan Akuntabel."
                        </p>
                    </div>

                    <div class="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-2 rounded-lg mr-4 mt-1">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <p class="text-gray-700">Meningkatkan kualitas pelayanan administrasi keuangan dan aset daerah.</p>
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-2 rounded-lg mr-4 mt-1">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <p class="text-gray-700">Mewujudkan tata kelola rumah tangga pimpinan yang tertib dan nyaman.</p>
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-2 rounded-lg mr-4 mt-1">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <p class="text-gray-700">Optimalisasi layanan keprotokolan yang profesional dan beretika.</p>
                        </div>
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition flex items-start">
                            <div class="bg-blue-100 text-blue-600 p-2 rounded-lg mr-4 mt-1">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </div>
                            <p class="text-gray-700">Mengembangkan kompetensi aparatur yang berintegritas.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <div class="mb-12">
                    ...
                    <p class="mt-4 text-gray-600">Bagan Susunan Organisasi Biro Umum Sekretariat Daerah.</p>
                </div>

                <div class="relative bg-gray-50 border-2 border-dashed border-gray-300 rounded-2xl p-8 md:p-16 flex flex-col items-center justify-center">
                    <svg class="w-20 h-20 text-gray-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    <h3 class="text-xl font-bold text-gray-700">Bagan Struktur Organisasi</h3>
                    <p class="text-gray-500 mb-6">Gambar bagan struktur organisasi akan ditampilkan di area ini.</p>
                    <button class="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded shadow-sm text-sm hover:bg-gray-50">
                        Unduh Dokumen Struktur (PDF)
                    </button>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-blue-900 text-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold">Tugas Pokok & Fungsi</h2>
                    <p class="text-blue-200 mt-2">Berdasarkan Peraturan Gubernur Bengkulu.</p>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-blue-800 p-8 rounded-xl hover:bg-blue-700 transition">
                        <div class="w-12 h-12 bg-yellow-500 rounded-lg flex items-center justify-center mb-6 text-blue-900 font-bold text-xl">
                            1
                        </div>
                        <h3 class="text-xl font-bold mb-4">Bagian Tata Usaha Keuangan</h3>
                        <p class="text-blue-200 text-sm leading-relaxed">
                            Melaksanakan penyiapan bahan perumusan kebijakan, pengoordinasian, pembinaan, fasilitasi, pemantauan dan evaluasi administrasi keuangan biro.
                        </p>
                    </div>
                    ...
                    <div class="bg-blue-800 p-8 rounded-xl hover:bg-blue-700 transition">
                        ...
                        <h3 class="text-xl font-bold mb-4">Bagian Rumah Tangga</h3>
                        <p class="text-blue-200 text-sm leading-relaxed">
                            Melaksanakan urusan rumah tangga pimpinan, pengelolaan aset, pemeliharaan gedung kantor, sarana prasarana, serta kebersihan lingkungan.
                        </p>
                    </div>
                    ...
                    <div class="bg-blue-800 p-8 rounded-xl hover:bg-blue-700 transition">
                        ...
                        <h3 class="text-xl font-bold mb-4">Bagian Protokol</h3>
                        <p class="text-blue-200 text-sm leading-relaxed">
                            Menyiapkan pelaksanaan acara pimpinan, pengaturan tata tempat, tata upacara, dan tata penghormatan kepada pejabat negara/tamu daerah.
                        </p>
                    </div>
                </div>
            </div>
